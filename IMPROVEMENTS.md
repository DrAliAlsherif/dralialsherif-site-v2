...
python tools/gen_expertise.py     # regenerate the 10 expertise pages + expertise/index.html
python tools/gen_services.py      # regenerate the 8 service pages + services/index.html
